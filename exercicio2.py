...
# Resumo: Exercício 1 — valida inteiro com try/except e informa se é par ou ímpar.
try:
...
try:
    ...
    # Resumo: Exercício 2 — valida a entrada e, com a hora válida, exibe uma saudação conforme a faixa horária.
...
# Resumo: Exercício 3 — classifica o primeiro nome conforme a quantidade de letras (curto/normal/muito grande).
